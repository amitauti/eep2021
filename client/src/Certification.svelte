...
<div class="table100 ver1 m-b-110">
  ...
  <th class="cell100 column1">Certification Title</th>
  <th class="cell100 column2">Issuer</th>
  ...
  {#each data as item, i}
    <tr class="row100 body">
      ...
      <td class="cell100 column2">{item.issuer}</td>
      <td class="cell100 column3">{item.year}</td>
    </tr>
  {/each}
